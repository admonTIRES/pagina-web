...
<div class="projects">
    <div class="projects__content">
        <div class="projects__info ">
            <h1 class="projects__title">Curso de materiales peligrosos (HAZMAT) </h1>
                ...
                <div class="course-tabs__container">
                    ...
                    <div class="course-tabs__content">
                        ...
                        <div class="course-tabs__section" data-content="temario">
                            ...
                            <br><br>
                            <p class="course-tabs__text">
                                Las personas que aprueben el examen del curso con un puntaje mayor o igual al (70%) reciben un diploma de Results In Performance y la constancia de competencias y/o habilidades laborales (DC-3).
                            </p>
